...
include('sessions_admin.php');
    function GetImageExtension($imagetype)
       ...
       if (isset($_POST['btn-upload'])) {
         $target = "../entrosum/img/sponsors/".basename($_FILES["fileimg"]["name"]);
         ...
         $sql = "insert into fusion(imgpath,type,link,name,contact,email) values ('$fileimg','sponsors','$link','$name','$contact','$email')";
         mysqli_query($db,$sql);
  ...
  <div class="container-fluid">
    <div class="row head">
      ...
      <div class="col-md-10 hello">
        <h1><i class="fas fa-tachometer-alt"></i>SPONSORS</h1>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="table-responsive table-bordered table-hover table-striped">
          <table class="table">
            ...
            <td><a href="delspon.php?id=<?php echo $row['id']?>">Delete File </a></td>
            <td><a href="editspon.php?edit=<?php echo $row['id']?>">Edit File</a></td>
          </tr>
          <?php
  }
  }
