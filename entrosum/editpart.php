...
include('sessions_admin.php');
	...
	{
		$id = $_GET['edit'];
		$res= mysqli_query($db,"SELECT * FROM fusion WHERE id='$id' and type='partners'");
...
function GetImageExtension($imagetype)
 {
   ...
   switch($imagetype)
   {
	...
	{
    $target = "../entrosum/img/partners/".basename($_FILES["newfileimg"]["name"]);
...
{
   $sql = "UPDATE fusion SET imgpath='$newfileimg',type='partners',link='$newLink',name='$newName',contact='$newContact',email='$newEmail' WHERE id='$id'";
...
else // no image uploaded
{
   // save data, but no change the image column in MYSQL, so it will stay the same value
    $sql = "UPDATE fusion SET type='partners',link='$newLink',name='$newName',contact='$newContact',email='$newEmail' WHERE id='$id'";
}

    $res 	 = mysqli_query($db,$sql) or die("Could not update");
  		echo "<meta http-equiv='refresh' content='0;url=partners.php'>";
  	}
...
<body>
  <div class="container-fluid">
    ...
    <div class="row" style="height:100vh; width: 100vw;">
      ...
      <div class="col-md-10">
      <div class="container">
        <form  action="editpart.php" enctype="multipart/form-data" method="post">


            <div class="form-group">
              <?php   $imageURL = '../entrosum/img/partners/'.$row['imgpath'];?>
                ...
                <p class="help-block">Images Only</p><br>
                  ...
                  <input type="text" name="newContact" value='<?php echo $row['contact'] ?>'><br>
