...
include("connect.php");
    ...
    function GetImageExtension($imagetype)
       ...
       if (isset($_POST['btn-upload'])) {
         ...
         $sql = "insert into fusion(imgpath,type) values ('$fileimg','banner')";
         mysqli_query($db,$sql);
  ...
  <div class="container-fluid">
    <div class="row head">
      ...
      <div class="col-md-10 hello">
        <h1><i class="fas fa-tachometer-alt"></i>BANNERS</h1>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="table-responsive table-bordered table-hover table-striped">
          <table class="table">
            ...
            <td><a href="delban.php?id=<?php echo $row['id']?>">Delete File </a></td>
          </tr>
          <?php
  }
  }
